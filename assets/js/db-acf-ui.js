 ...
 translateDeletePopup() {
  ...
  observer.observe(document.body, { childList: true, subtree: true });
    ...
    addModal($layout) {
      ...
      // remove any old toggle duplicates
      $controls.find(".acf-layout-toggle-btn").remove();
    ...
    overlay(show) {
      if (show && !$("body").hasClass("acf-modal-open")) {
        $('<div id="acf-flexible-content-modal-overlay" />')
          .on("click", ACFDB.close)
          .appendTo("body");
